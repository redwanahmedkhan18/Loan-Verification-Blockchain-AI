...
export declare function getCompilerInput(solidity: SolidityBuildSystem, rootFilePath: string, sourceName: string, buildProfileName: string): Promise<CompilerInput>;
