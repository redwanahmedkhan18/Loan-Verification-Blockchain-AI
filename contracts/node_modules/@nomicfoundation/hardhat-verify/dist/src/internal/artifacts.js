...
export async function getCompilerInput(solidity, rootFilePath, sourceName, buildProfileName) {
    const getCompilationJobsResult = await solidity.getCompilationJobs([path.join(rootFilePath, sourceName)], {
